...
const BOAT_DEFS: VehicleDef[] = [
  { id: 'boat-kayak', name: 'Caiaque', category: 'iate', variant: 'kayak', price: 700, image: wikimediaImage('Sea Kayak.JPG') },
  { id: 'boat-motor', name: 'Barco a Motor', category: 'iate', variant: 'motorboat', price: 22000, image: wikimediaImage('Motor yacht in Poros.JPG') },
  { id: 'boat-lancha', name: 'Lancha de Luxo', category: 'iate', variant: 'speedboat', price: 110000, image: wikimediaImage('Luxury yacht Senses 2.JPG') },
  { id: 'boat-ladym', name: 'Iate "Lady M"', category: 'iate', variant: 'yacht', price: 480000, image: wikimediaImage('Lady M yacht.jpg') },
  { id: 'boat-azzam', name: 'Superiate Privado', category: 'iate', variant: 'superyacht', price: 150000000, image: wikimediaImage('AzzamCadiz.jpg') },
...
const PLANE_DEFS: VehicleDef[] = [
  { id: 'plane-cessna172', name: 'Cessna 172', category: 'aviao', variant: 'touring', price: 250000, image: wikimediaImage('Cessna 172 - 2.jpg') },
  { id: 'plane-r44', name: 'Robinson R44', category: 'aviao', variant: 'helicopter', price: 500000, image: wikimediaImage('Robinson R44 Raven II Bakoma.JPG') },
  { id: 'plane-citation', name: 'Cessna Citation Jet', category: 'aviao', variant: 'lightjet', price: 9900000, image: wikimediaImage('Cessna Citation Jet.jpg') },
  { id: 'plane-g650', name: 'Gulfstream G650', category: 'aviao', variant: 'longrange', price: 70000000, image: wikimediaImage('Gulfstream G650.JPG') },
  { id: 'plane-concorde', name: 'Concorde', category: 'aviao', variant: 'supersonic', price: 250000000, image: wikimediaImage('British Concorde.jpg') },
